...
public class ExcelCliente {
	...
	public HSSFWorkbook generateExcel() {
		...
		// Generate fonts
		headerFont  = createFont(HSSFColor.WHITE.index, (short)11, true);
		contentFont = createFont(HSSFColor.BLACK.index, (short)11, true);
		
		// Generate styles
		headerStyle  = createStyle(headerFont,  HSSFCellStyle.ALIGN_CENTER, HSSFColor.BLACK.index, true, HSSFColor.WHITE.index);
		...
		List<String> headerValues = ConCliente.getTableHeaders();
		...
		List<List<String>> contentRowValues = ConCliente.getTableContent(20);
